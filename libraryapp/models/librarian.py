...
#This is how you set up users in DJANGO if you want to capture user info
class Librarian(models.Model):
    # for every entry in auth user table, we will have a matching entry in librarian table (OneToOneField)
    #When we make a librarian, ITS ALSO A USER
